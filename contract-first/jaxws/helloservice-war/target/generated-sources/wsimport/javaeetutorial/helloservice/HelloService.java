 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://helloservice.javaeetutorial/", wsdlLocation = "file:/home/berhart/Desktop/WebServices%20and%20Cloud-based%20Systems/WebServices-Assignment1/contract-first/jaxws/helloservice-war/src/main/resources/HelloService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/berhart/Desktop/WebServices%20and%20Cloud-based%20Systems/WebServices-Assignment1/contract-first/jaxws/helloservice-war/src/main/resources/HelloService.wsdl");
    ...
    public HelloPortType getHelloPort() {
        return super.getPort(new QName("http://helloservice.javaeetutorial/", "HelloPort"), HelloPortType.class);
    }
    ...
    public HelloPortType getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloservice.javaeetutorial/", "HelloPort"), HelloPortType.class, features);
    }
